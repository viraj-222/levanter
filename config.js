...
module.exports = {
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,Vihanga-md',
  ALWAYS_ONLINE: process.env.ALWAYS_ONLINE,
  LOG_MSG: toBool(process.env.LOG_MSG) || false,
  RMBG_KEY: process.env.RMBG_KEY || '5qUgfembihLFPPRnb3mvSVL9',
  ...
  MENTION: process.env.MENTION || 'https://telegra.ph/file/e3947a665144372a172aa.jpg',
